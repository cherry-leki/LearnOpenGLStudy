...
def main(args):
    ...
    # set shader program
    shader_program = Shader('05_transformations/05_vtx_shader.vs', '05_transformations/05_frag_shader.fs')
    ...
    while not glfw.window_should_close(window):
        ...
        # draw
        trf_location = glGetUniformLocation(shader_program.id, "transform")
